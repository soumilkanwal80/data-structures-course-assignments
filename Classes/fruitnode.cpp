...
{
	cout<<this->type<<setw(20)<<this->x<<setw(20)<<this->y<<setw(20)<<this->price<<setw(20)<<this->weight<<setw(20)<<this->calories<<setw(20)<<this->amount<<setw(20)<<this->hours<<":"<<this->mins<<endl;
}
...
int fruitNode::returnCalories()
{
	return this->calories;
}

int fruitNode::returnAmount()
{
	return this->amount;
}

int fruitNode::returnPrice()
{
	return this->price;
}

string fruitNode::returnName()
{
	return this->type;
}

void fruitNode::modifyAmount(int x)
{
